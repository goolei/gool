...
$conf=array(
	...
	/*结算转账信息设置*/
	'wxtransfer_desc' => '一贝支付自动结算', //微信企业付款 付款说明
	'payer_show_name' => '一贝支付', //单笔转账到支付宝接口 付款方显示姓名
	...
	/*用户中心配置*/
	'web_name' => '一贝支付', //网站名称
	'web_qq' => '1943162916', //客服QQ
	'quicklogin' => 1, //快捷登录设置（1为支付宝快捷登录，2为QQ快捷登录）

	/*申请商户配置*/
	'is_reg' => 1, //是否开放自助申请商户
	'is_payreg' => 1, //是否付费申请
	'reg_pid' => '1004', //付费申请收款商户ID
	'reg_price' => '48', //商户申请价格
	...
	'mail_name' => '1943162916@qq.com', //邮箱账号
